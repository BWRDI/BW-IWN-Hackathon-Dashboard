...
enable_streamflow_overlay = st.sidebar.checkbox("Show Streamflow Trend", value=True)

# Check if the selected site is one of the Five Mile Creek sites
        ...
        if enable_streamflow_overlay and param in ["Nitrate", "Conductivity"]:
            fig.add_trace(
                go.Scatter(
                    ...
                    mode='lines', 
                    name='Streamflow', 
                    line=dict(color='rgba(255, 171, 171, 0.5)')  # 50% opacity blue line
                ),
